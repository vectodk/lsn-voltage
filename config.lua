...
Config.mainHackingTool = 'usb_drive'                    -- Item thats needs to be used next to a windmill
Config.secondHackingTool = 'usb_drive'                  -- Item thats needs to be in the inventory for it to work
...
Config.policeAlertType =
'server'                                                -- 'client' or 'server'   --> This will either use the client(ps-dispatch) or server(default qbx_police one) sided police function
